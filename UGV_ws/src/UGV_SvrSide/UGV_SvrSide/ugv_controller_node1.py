...
class UGVController(Node):
    def __init__(self):
        ...
        # State
        self.current_x     = 4.85   # metres, world frame
        self.current_y     = 16.75
        self.current_z     = 0.0
