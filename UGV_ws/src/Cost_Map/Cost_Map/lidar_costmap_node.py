...
class LidarCostmapGenerator(Node):
    ...
    def _declare_parameters(self):
        ...
        self.declare_parameter('inflation_radius_meters',   0.15) # The buffer zone between an obstacle or caution cell.
        self.declare_parameter('flat_caution_threshold',    0.15) # meters above ground plane 0.03
        self.declare_parameter('caution_obstacle_threshold', 0.20) # meters above ground plane 0.08
